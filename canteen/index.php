                            ...
                            <div class="col-lg-6">
                                <div class="single_crm ">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM complaints where status=0 && complaint_Type='canteen'";
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM complaints where status=1 && complaint_Type='canteen'";
                                        $query_run = mysqli_query($con, $query);
                                        $row = mysqli_num_rows($query_run);
                                        echo '<h4> ' . $row . '</h4>';
                                        ?>
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM visitor where status=0 && purpose='canteen'";
                                        $query_run = mysqli_query($con, $query);
                                        $row = mysqli_num_rows($query_run);
                                        echo '<h4> ' . $row . '</h4>';
                                        ?>
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT * FROM rent where status=0 && SelectCompanys='$company' " ;
                                        $query_run = mysqli_query($con, $query);
                                        $total_rent = 0;
                                        if (mysqli_num_rows($query_run) > 0) {
                                            while ($row = mysqli_fetch_array($query_run)) {
