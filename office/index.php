            ...
            <div class="row ">
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM complaints where status=1 and complaint_Type='office' ||status=1 and complaint_Type='staff'";
                                        $query_run = mysqli_query($con, $query);
                                        $row = mysqli_num_rows($query_run);
                                        echo '<h4> ' . $row . '</h4>';
                                        ?>
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT * FROM rent where SelectCompanys='$company'";
                                        $query_run = mysqli_query($con, $query);
                                        $total_rent = 0;
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT * FROM rent where status=0 AND SelectCompanys='$company'";
                                        $query_run = mysqli_query($con, $query);
                                        $total_rent = 0;
                                        if (mysqli_num_rows($query_run) > 0) {
                                            while ($row = mysqli_fetch_array($query_run)) {
                ...
                <div class="col-xl-6">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        error_reporting(E_ERROR | E_PARSE);
                        require_once("config.php");
                        $result = mysqli_query($con, "SELECT * FROM complaints  where complaint_Type='office' || complaint_Type='staff' limit 5 ");
                        if (isset($_GET[''])) {
                            echo $_GET['msg'];
                        }
                        include_once('./index.php');
