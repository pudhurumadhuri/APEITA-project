...
$id1=$_SESSION['id'];
$q =mysqli_query($con, "SELECT * FROM users WHERE id='$id1'");
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM complaints where Complaint_Type='staff'";
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm ">
                                    ...
                                    <div class="crm_body">
                                        ...
                                        <?php
                                        require 'config.php';
                                        $query = "SELECT id FROM complaints where status=1 && Complaint_Type='staff' limit 5";
                                        $query_run = mysqli_query($con, $query);
                                        $row = mysqli_num_rows($query_run);
                                        echo '<h4> ' . $row . '</h4>';
                                        ?>
                        ...
                        ?>
                            <div class="single_user_pil d-flex align-items-center justify-content-between">
                                ...
                                <?php
                                    if ($row['status'] == "1")
                                        echo
                                        "<a href=view_complaints.php?id=". $row['id']." class='status_btn'>solved</a>";
                                    else
                                        echo
                                        "<a href=view_complaints.php?id=".$row['id']." class='status_btn' style='background-color: #f44336;'>unsolved</a>";
                                ?>
                                </div>
                            </div>
                        <?php
